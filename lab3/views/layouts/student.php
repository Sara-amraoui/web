    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Student</div>
            </div>
        </div>
        <nav class="sidebar-nav">
            <a class="nav-link" href="<?= e(url('student_dashboard')) ?>">Dashboard</a>
            <a class="nav-link" href="<?= e(url('student_history')) ?>">GPA history</a>
